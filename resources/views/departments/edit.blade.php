                ...
                <div class="p-8 text-gray-900">
                    <form method="POST" action="{{ route('departments.update', $department) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full border-gray-300 focus:border-brand-500 focus:ring-brand-500 rounded-md shadow-sm" type="text" name="name" :value="old('name', $department->name)" required autofocus />
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" class="block mt-1 w-full border-gray-300 focus:border-brand-500 focus:ring-brand-500 rounded-md shadow-sm">{{ old('description', $department->description) }}</textarea>
